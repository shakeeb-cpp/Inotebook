...
// ROUTES:3 Update an existing note using: PUT "/api/notes/updatenotes" Login required
...
// ROUTES:4 Delete an existing note using: DELETE "/api/notes/deletenotes" Login required
